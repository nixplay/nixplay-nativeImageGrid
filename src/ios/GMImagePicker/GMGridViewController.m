...
- (BOOL)collectionView:(UICollectionView *)collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell.isEnabled) {
        ...
        if(self.picker.selectedAssets.count >= kGMImageMaxSeletedNumber) {
            NSString *text = NSLocalizedStringFromTable(@"picker.selection.max-selection.error.message", @"GMImagePicker", nil);
            NSString *alertString = [NSString stringWithFormat:text,kGMImageMaxSeletedNumber];
